...
@Action(value = "rightClickOffset")
public class RightClickOffsetKeyword extends WebUIAbstractKeyword {
    ...
    public Object execute(Object ...params) {
        ...
        rightClickOffset(to, offsetX, offsetY, flowControl)
    }

    @CompileStatic
    public void rightClickOffset(TestObject to, int offsetX, int offsetY, FailureHandling flowControl) throws StepFailedException {
        ...
        }, flowControl, true, (to != null) ? MessageFormat.format(CoreWebuiMessageConstants.KW_MSG_CANNOT_RIGHT_CLICK_ON_OBJ_X_OFFSET_Y_Z, to.getObjectId(), offsetX, offsetY)
        : CoreWebuiMessageConstants.KW_MSG_CANNOT_RIGHT_CLICK_ON_OBJ_OFFSET)
    }
}
