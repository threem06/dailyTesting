...
@Action(value = "switchToFrame")
public class SwitchToFrameKeyword extends WebUIAbstractKeyword {
    ...
    public Object execute(Object ...params) {
        ...
        return switchToFrame(to,timeOut,flowControl)
    }

    @CompileStatic
    public boolean switchToFrame(TestObject to, int timeOut, FailureHandling flowControl) throws IllegalArgumentException,
