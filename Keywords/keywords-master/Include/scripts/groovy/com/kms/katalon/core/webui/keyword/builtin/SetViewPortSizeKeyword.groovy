...
@Action(value = "setViewPortSize")
public class SetViewPortSizeKeyword extends WebUIAbstractKeyword {
    ...
    public Object execute(Object ...params) {
        ...
        setViewPortSize(width,height,flowControl)
    }
    ...
    public void setViewPortSize(int width, int height, FailureHandling flowControl) {
        WebUIKeywordMain.runKeyword({
            ...
            logger.logPassed(MessageFormat.format(StringConstants.KW_LOG_PASSED_SET_VIEWPORT_WIDTH_X_HEIGHT_Y, [width.toString(), height.toString()] as Object[]))
