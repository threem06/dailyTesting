...
WebUI.verifyElementText(findTestObject('dailyTesting/Backoffice/Betting/Match/matchManagement/matchDetails/labelPlayerId'), 
    playerId)

WebUI.verifyElementText(findTestObject('dailyTesting/Backoffice/Betting/Match/matchManagement/matchDetails/labelSelection'), 
    selection)

WebUI.verifyElementText(findTestObject('dailyTesting/Backoffice/Betting/Match/matchManagement/matchDetails/labelOdds'), 
    odds)
