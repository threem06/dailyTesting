...
WebUI.setText(findTestObject('Backoffice/Clients/Registration/input_password'), Password)

WebUI.setText(findTestObject('Backoffice/Clients/Registration/input_confirmp'), Password)
