...
RunConfiguration.setExecutionSettingFile("C:\\Users\\ops.02\\git\\UCF\\Reports\\dailyTesting\\1.accountCreation\\createAccount\\20181122_132514\\execution.properties")

TestCaseMain.beforeStart()

TestCaseMain.startTestSuite('Test Suites/dailyTesting/1.accountCreation/createAccount', suiteProperties, [new TestCaseBinding('Test Cases/dailyTesting/2.login/openBrowserFrontend', 'Test Cases/dailyTesting/2.login/openBrowserFrontend',  null), new TestCaseBinding('Test Cases/dailyTesting/1.accountCreation/signUp', 'Test Cases/dailyTesting/1.accountCreation/signUp',  [ 'email' : 'testDaily@gmail.com' , 'password' : '123123' , 'username' : 'testDaily' , 'name' : 'test' ,  ]), new TestCaseBinding('Test Cases/dailyTesting/2.login/frontendLogin', 'Test Cases/dailyTesting/2.login/frontendLogin',  [ 'password' : '123123' , 'username' : 'testDaily' ,  ]), new TestCaseBinding('Test Cases/dailyTesting/2.login/backofficeLogin', 'Test Cases/dailyTesting/2.login/backofficeLogin',  null), new TestCaseBinding('Test Cases/dailyTesting/1.accountCreation/playerList', 'Test Cases/dailyTesting/1.accountCreation/playerList',  [ 'username' : 'testDaily' ,  ])])
